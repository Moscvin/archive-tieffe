            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <h3> Elenco delle province</h3>

                        @if(in_array('A',$chars))
                            <a class="btn btn-primary "  href="{{ "/province_add" }}"><i class="fas fa-plus"></i>&nbsp;Nuova provincia</a>
                        @endif
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4>Sei sicuro di voler eliminare la provincia <b>{core_item}</b>?</h4>
                </div>
