            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        @endif
                        {!! Form::open(array('url' => '/location/' . $location->id_sedi . '/update?backRoute='.$backRoute, 'method' => 'post', 'files' => true, 'enctype' => 'multipart/form-data','class'=>'form-horizontal'))  !!}
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group mt-23">
                                        <select class="form-control" name="tipologia" id="tipologia" style="width: 100%; margin-left: 15px;">
                                            @foreach($types as $type)
                                                <option value="{{$type}}" {{$location->tipologia == $type ? 'selected' : ''}}>{{$type}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-10 d-flex">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="indirizzo_sl" style="margin-left: 15px;" placeholder="Via/Piazza" value="{{$location->indirizzo_via or old('indirizzo_sl')}}">
                                    </div>
                                    <div class="form-group prefisso2">
                                        <input type="text" class="form-control" name="numero_civico_sl"
                                            placeholder="Civico e int."
                                            value="{{$location->indirizzo_civico or old('numero_civico_sl')}}">
                                    </div>
                                    <div class="form-group prefisso2">
                                        <input maxlength="5" type="text" class="form-control" name="cap_sl" placeholder="CAP"
                                            value="{{$location->indirizzo_cap or old('cap_sl')}}">
                                    </div>
                                    <div class="form-group autocomplete ac_comune_sl" style="width: 100%;position:relative;">
                                        <input type="text" class="form-control" name="comune_sl" placeholder="Comune"
                                                value="{{$location->indirizzo_comune or old('comune_sl')}}" autocomplete="off">
                                    </div>
                                    <div class="form-group prefisso2">
                                        <input  onkeyup="
											  ...
											  this.setSelectionRange(start, end);" maxlength="2" style="text-transform:uppercase"  type="text" class="form-control" name="provincia_sl" placeholder="Provincia"
                                            value="{{$location->indirizzo_provincia or old('provincia_sl')}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 d-flex">
                                    <div class="form-group w-50">
                                        ...
                                        <input type="text" class="form-control " name="prefisso_1"
                                                value="{{ $location->prefisso_1 or old('prefisso_1','+39')}}" tabindex="-1">
                                    </div>
                                    <div class="form-group w-66">
                                        <input type="text" class="form-control" name="telefono_1"
                                            value="{{$location->telefono1 or old('telefono_1')}}">
                                    </div>
                                    <div class="form-group w-50">
                                        <label>Tel. 2</label>
                                        <input type="text" class="form-control " name="prefisso_2"
                                                value="{{ $location->prefisso_2 or old('prefisso_2','+39')}}"
                                                tabindex="-1">
                                    </div>
                                    <div class="form-group w-66">
                                        <input type="text" class="form-control" name="telefono_2"
                                            value="{{$location->telefono2 or old('telefono_2')}}">
                                    </div>
                                    <div class="form-group">
                                        <label for="email" > Email </label>
                                        <input type="email" name="email" class="form-control" placeholder="Email" value="{{$location->email or old('email')}}">
                                    </div>
                                    <div class="form-group">
                                        <label for="note" > Note </label>
                                        <input type="note" name="note" class="form-control" placeholder="note" value="{{$location->note or old('note')}}">
                                    </div>
                                </div>
                            </div>
                        </div>
