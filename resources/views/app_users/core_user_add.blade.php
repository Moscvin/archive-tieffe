                    ...
                    <div class="box-body">
                        ...
                        {!! Form::open(array('url' => '#', 'method' => 'post', 'files' => true, 'enctype' => 'multipart/form-data','class'=>'form-horizontal'))  !!}
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 col-md-2 col-form-label {{$see ? '' : 'required'}}" for="isactive">Attivo:</label>
                                <div class="col-sm-3 col-md-2">
                                    ...
                                    @else
                                       <select class="form-control status-select" name="isactive" id="isactive" >
                                            ...
                                            <option {{ isset($page->isactive) ? ($page->isactive==1 ? "selected=selected" : '') : 'selected'}} {{ (old("isactive") == 1 ? "selected":"") }} value='1'>Si</option>
                                        </select>
                                    @endif
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3 col-md-2 col-form-label {{$see ? '' : 'required'}}" for="id_group">Gruppo:</label>
                                <div class="col-sm-3 col-md-2">
                                    @if($see)
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 col-md-2 col-form-label {{$see ? '' : 'required'}}" for="username">Username:</label>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 col-md-2 col-form-label {{$see ? '' : 'required'}} " for="family_name">Cognome:</label>
                                <div class="col-sm-7 col-lg-4">
                                    @if($see)
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 col-md-2 col-form-label" for="name">Nome:</label>
                                <div class="col-sm-7 col-lg-4">
                                    @if($see)
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 col-md-2 col-form-label {{$see ? '' : 'required'}}" for="email">Email:</label>
                                <div class="col-sm-7 col-lg-4">
                                    @if($see)
                            ...
                            <div class='row'>
                                <div class="col-sm-6">
                                    ...
                                    @endif
                                    <a class="btn btn-warning "  href="{{ "/app_user" }}"><i class="fas fa-times"></i>&nbsp;&nbsp;Annulla</a>
                                </div>
                            </div>
...
<script>
    var seriaBoxSwitch = function(context) {
        var box = document.getElementById('seraBox');
        var outsiderBox = document.getElementById('outsiderBox');
        if(context.value == 9 && box.classList.contains('hidden')) {
            box.classList.remove('hidden');
            outsiderBox.classList.remove('hidden');
        } else if(context.value != 9 && !box.classList.contains('hidden')) {
            box.classList.add('hidden');
            outsiderBox.classList.add('hidden');
        }
    }
    seriaBoxSwitch(document.querySelector('[name=id_group]'));
</script>
@endsection
