...
@section('content')
    ...
    <div class="container-fluid spark-screen print_clienti" id="app">
        <works-invoiced :chars="{{json_encode($chars)}}"></works-invoiced>
    </div>
    ...
    @section('js')
        ...
        <script>
            $(document).on("click",".export-tbl",null,function(){ $(".hide-excel-dw").trigger('click'); });
        </script>
