                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <h3 >Elenco delle opzioni</h3>
                            <a href="{{ "/core_admin_options_add" }}" class="btn btn-primary" ><i class="fas fa-plus"></i>&nbsp;&nbsp;Nuova Opzione</a>
                    </div>
                    <div class="box-body">
                                ...
                                @if($roles)
                                    ...
                                    @foreach($roles as $role)
                                        <tr class="tr">
                                            ...
                                            <td>{{$role->value or ''}}</td>
                                            <td class="action_btn">    
                                                <a href="{{'/core_admin_options_add'}}/{{$role->id_option}}" class="btn btn-xs btn-info" title="modifica"><i class='fas fa-edit'></i></a>&nbsp;
                                            </td>
                                            <td class="action_btn">
                                                <button data-my-id="{{$role->id_option}}" type="button" class="action_del btn btn-xs btn-warning" title="Elimina">
