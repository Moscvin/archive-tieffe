                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input class="form-control" id="description" type="text" name="description" value="{{$page->description or ''}}" />
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="link">Link</label>
                                    <input class="form-control" id="link" type="text" name="link" value="{{$page->link or ''}}" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-4">
                                    <label for="list_order">List order</label>
                                    <input class="form-control" id="list_order" type="number" name="list_order" value="{{$page->list_order or ''}}" />
                                </div>
                                <div class="form-group col-md-4">
                                    ...
                                    <select name="id_parent" class="form-control">
                                        ...
                                        @if($menus_c)
                                            @foreach($menus_c as $menu_c)
                                                <option
                                                        @if(!empty($page) && $menu_c['id_menu_item'] == $page->id_parent) selected="selected" @endif
                                                        value="{{$menu_c['id_menu_item']}}" >{{$menu_c['description']}} {{parent_if($menu_c['id_parent'])}}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                                <div class="form-group col-md-4">
                                    ...
                                    <input class="form-control" id="icon" type="text" name="icon" value="{{$page->icon or ''}}" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                                        ...
                                                        <select name="id_group[{{$atrib['id_permission']}}][]" class="attr-role form-control a1">
                                                            ...
                                                            @if($roles2)
                                                                @foreach($roles2 as $item)
                                                                    <option @if($atrib['id_group'] == $item->id_group) selected='selected' @endif value="{{ $item->id_group or "" }}"> {{ $item->description or "" }} </option>
                                                                @endforeach
                                                            @endif
                                                        </select>
                                                    </div>
