                    ...
                    <div class="box-body">
                        <div class="table-responsive">
                            <table class="table table-responsive table-bordered table-hover table-condensed" id="permission_exceptions_table">
                              ...
                              <tbody>
                                @foreach($permissionsexceptions as $permision)
                                <tr>
                                  <td>{{ $permision->core_permissions_user->username }}</td>
                                  <td>
                                    <a title="Modifica" href="/core_permission_exceptions_add/{{ $permision->id_user }}" class="action_block btn btn-xs btn-info">
                                      <i class="fas fa-edit"></i></a>
                                      <button title="Elimina" data-my-id="{{ $permision->id_user }}" data-name="{{ $permision->core_permissions_user->username }}" class="action_del btn btn-xs btn-warning">
