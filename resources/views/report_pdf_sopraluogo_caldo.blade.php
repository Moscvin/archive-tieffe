            ...
            <div class="column column_nb column_huge">
                ...
                <div class="row">
                    <div class="column column_nb column_48">
                        <table>
                            <tbody>
                                ...
                                @endif
                                @if($intervent_machinery->machinery->SC_posizione_cana)
                                <tr>
                                    <td class="l60">
                                        <p>Posizione Canna Fumaria</p>
                                    </td>
                                    <td class="l40 accent">{{ $intervent_machinery->machinery->SC_posizione_cana }}</td>
                                </tr>
                                @endif
                                @if($intervent_machinery->machinery->SC_certif_canna)
                                <tr>
                                    <td class="l60">
                                        <p>Certificazione Canna Fumaria</p>
                                    </td>
                                    <td class="l40 accent">
                                        {{ $intervent_machinery->machinery->SC_certif_canna == 2? 'Si' : 'No' }}
                                    </td>
                                </tr>
                                @endif

                                @if($intervent_machinery->machinery->SC_cana_da_intubare)
                                <tr>
                                    <td class="l60">
                                        <p>Canna Fumaria da Intubare</p>
                                    </td>
                                    <td class="l40 accent">
                                        {{ $intervent_machinery->machinery->SC_cana_da_intubare == 2 ? 'Si' : 'No' }}
                                    </td>
                                </tr>
                                @endif

                                @if($intervent_machinery->machinery->SC_sezione)
                                <tr>
                                    <td class="l60">
                                        <p>Sezione (diametro)</p>
                                    </td>
                                    <td class="l40 accent">
                                        {{ $intervent_machinery->machinery->SC_sezione  }}
                                    </td>
                                </tr>
                                @endif

                                @if($intervent_machinery->machinery->SC_tetto_legno)
                                <tr>
                                    <td class="l60">
                                        <p>Tetto in Legno</p>
                                    </td>
                                    <td class="l40 accent">
                                        {{ $intervent_machinery->machinery->SC_tetto_legno == 2 ? 'Si' : 'No' }}
                                    </td>
                                </tr>
                                @endif
                    ...
                    <div class="column column_nb column_accent">
                        <table>
                            <tbody>
                                @if($intervent_machinery->machinery->SC_metri)
                                <tr>
                                    <td class="l60">
                                        <p>Metri</p>
                                    </td>
                                    <td class="l40 accent">
                                        <p>{{ $intervent_machinery->machinery->SC_metri }}</p>
                                    </td>
                                </tr>
                                @endif

                                @if($intervent_machinery->machinery->SC_curve)
                                <tr>
                                    <td class="l60">
                                        <p>Curve</p>
                                    </td>
                                    <td class="l40 accent">
                                        <p>{{ $intervent_machinery->machinery->SC_curve }}</p>
                                    </td>
                                </tr>
                                @endif
                                @if($intervent_machinery->machinery->SC_materiale)
                                <tr>
                                    <td class="l60">
                                        <p>Materiale</p>
                                    </td>
                                    <td class="l40 accent">
                                        <p>{{ $intervent_machinery->machinery->SC_materiale }}</p>
                                    </td>
                                </tr>
                                @endif
                                @if($intervent_machinery->machinery->SC_ind_com)
                                <tr>
                                    <td class="l60">
                                        <p>Industriale / Commerciale</p>
                                    </td>
                                    <td class="l40 accent">
                                        <p>{{ $intervent_machinery->machinery->SC_ind_com == 2? 'Si' : 'No' }}</p>
                                    </td>
                                </tr>
                                @endif

                                @if($intervent_machinery->machinery->SC_tondo_oval)
                                <tr>
                                    <td class="l60">
                                        <p>Tondo/Ovale</p>
                                    </td>
                                    <td class="l40 accent">
                                        <p>{{ $intervent_machinery->machinery->SC_tondo_oval }}</p>
                                    </td>
                                </tr>
                                @endif

                                @if($intervent_machinery->machinery->distanze)
                                <tr>
                                    <td class="l60">
                                        <p>Distanze</p>
                                    </td>
                                    <td class="l40 accent">
                                        <p>{{ $intervent_machinery->machinery->distanze }}</p>
                                    </td>
                                </tr>
                                @endif
                            </tbody>
