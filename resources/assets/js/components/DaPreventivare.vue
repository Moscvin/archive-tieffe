        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <div v-if="mode == 'view'">
                        <div class="pull-left">
                            <h3>Rapporto di intervento da preventivare</h3>
                        </div>
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-12 d-flex-between">
                            <a  href="/rapporti-da-preventivare" id="noprint2" class="btn btn-warning btn_general save-btn"><span>Annulla</span></a>
                            <button class="btn btn-success btn_general save-btn" @click="save()" v-if="mode=='edit'"><span>Salva</span></button>
                        </div>
                    </div>
                </div>
            </div>
  ...
  methods: {
    save() {
      this.$validator.validate().then(result => {
        if(result) {
          axios.post("/rapporti-da-preventivare/saveRapportiDaPreventivare", {
            ...
            .then(
              function(res) {
                if((res.data = "succes"))window.location.href = "/rapporti-da-preventivare";
              }.bind(this)
            );
        } else {
          this.$notify.error({
