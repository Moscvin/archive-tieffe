        ...
        <div class="col-md-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    <div class="pull-left">
                        <h3>Elenco rapporti fatturazione mensile</h3>
                    </div>
                            ...
                            <table class="table"> 
                                ...
                                <tbody>
                                    <tr v-for="(operation, i) in operations" :key="i" :class="operation.tipo == 'Verde' ? 'verde' : 'meccanica'">
                                        ...
                                        <td id="noprint22"> 
                                            <a :href="'/lavori_mensili_add/' + operation.id_intervento + '/view'" class="btn btn-xs btn-primary" title="Visualizza">
                                                <i class="fa fa-eye"></i>
                                            </a>
                                        </td>
                                        <td id="noprint33">
                                            <a :href="'/lavori_mensili_add/' + operation.id_intervento + '/edit'" class="btn btn-xs btn-info" title="Modifica">
...
export default {
    ...
    computed: {
        printTitle() {
            var title = 'Lavori';
            title += this.date_start ? (' di ' + this.$moment(this.date_start, 'YYYY-MM').format("MMMM YYYY")) : '';
            return title;
        },
        filename() {
            var filename = 'Lavori';
            filename += this.date_start ? (' di ' + this.$moment(this.date_start, 'YYYY-MM').format("MMMM YYYY")) : '';
            filename += '.xls';
            return filename;
        }
    },
