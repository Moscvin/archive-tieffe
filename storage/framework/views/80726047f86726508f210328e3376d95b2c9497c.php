                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <?php if(in_array('A',$chars)): ?>
                            <a class="btn btn-primary " href="<?php echo e($addRoute ?? "/customer_add"); ?>"><i class="fas fa-plus"></i>&nbsp;Nuovo
                                Cliente</a>
                        <?php endif; ?>
                    ...
                    <div class="box-body">
                        <form class="form-inline export_tools">
                            ...
                            <div class="form-group fm-refresh">
                                <a href="/<?php echo e(Request::path()); ?>" id="ex_refresh" class="btn btn-sm btn-danger"><i
